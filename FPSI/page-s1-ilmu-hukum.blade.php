...
<div class ="grid">
  ...
  <nav class='my-sticky'>
      ...
      <a href="#visi-misi-tujuan" class="section-anchor" :class="{'usu-bg-tertiary text-white': activeSection === $el.hash}">Visi, Misi dan Tujuan</a>
...
<section id="visi-misi-tujuan" class="vision mt-5"  x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
    ...
    Menjadi Prodi S-1 Ilmu psikologi yang terkemuka, yang menghasilkan lulusan berkualitas, bermoral, profesional dan memiliki keunggulan kompetitif, baik di tingkat nasional maupun internasional.
  	</p>
	<div class="missions">
    <div class="container">
		...
		<div class="d-block d-sm-flex justify-content-center flex-wrap p-2">
			...
			<img src="https://api.iconify.design/dashicons:code-standards.svg?color=white&width=60px"/>
			  ...
			  <h2 style="text-align:center">Standard Nasional</h2>
        ...
        Menyelenggarakan pendidikan dan penelitian psikologi berbasis Kerangka Kualifikasi Nasional Indonesia (KKNI) dan Standard Nasional Pendidikan Tinggi (SN Dikti) yang menekankan pada pemecahan masalah sesuai dengan trend perkembangan psikologi nasional dan  internasional.
			...
			<img src="https://api.iconify.design/game-icons:teacher.svg?color=white&width=60px"/>
			  ...
			  <h2  style="text-align:center">Meningkatkan Mutu Pembelajaran</h2>
			  <p style="text-align:center">
        Meningkatkan mutu proses belajar mengajar melalui pembangunan sarana, prasarana, fasilitas pendidikan, pembinaan karir serta peningkatan kesejahteraan dosen dan pegawai.
			...
			<img src="https://api.iconify.design/game-icons:materials-science.svg?color=white&width=60px"/>
			  ...
			  <h2  style="text-align:center">Kegiatan Ilmiah</h2>
			  <p style="text-align:center">
        Melibatkan dosen dan mahasiswa dalam kegiatan ilmiah dan pengabdian pada masyarakat dengan pemecahan masalah (solutions) sesuai dengan pengembangan psikologi ditingkat nasional dan internasional sesuai dengan kompetensinya.
			</p>
			</div>
			<div class="academic-flex">
			<div class="d-flex justify-content-center">
    ...
    <div class="container">
		<div class="akreditasi-list">
			<div class="kontenakreditasi">
			  <h2>Program Sarjana Ilmu psikologi</h2>
		...
		<div class="popup-container">
				...
				<p>
					<a class="popup-close" href="#closed">X</a>
						...
						<h3>
							Akreditasi Program Studi S-1 Ilmu psikologi USU
						</h3>
					</div>
...
<section id ="prospek-karir" class="vision mt-5" x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
  ...
  <p style ="text-align:center" class="container mt-5 h5">
	Prospek karir setelah lulus dari program studi S-1 Ilmu psikologi sangatlah menjanjikan. Berikut ini adalah prospek karirnya:
	</p>
	<div class ="prospek">
...
<section id = "informasi-kontak" class="info mt-3" x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
    ...
    <div class="info-kontak">
        <p>
            <b>
                Program Studi Sarjana Ilmu psikologi
			...
			<td>
              <i class="fa-brands fa-facebook"></i> <a href="https://www.facebook.com/komunikasi.usu.5?mibextid=ZbWKwL" target="_blank">Komunikasi psi USU</a>
            </td>
            </tr>
            <tr>
              <td>
                <i class="fa-solid fa-globe"></i> <a href="https://psi.usu.ac.id" target="_blank">psi.usu.ac.id</a>
              </td>
			  <td>
...
<section id = "jadwal-kuliah" class="vision mt-5" x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
					...
					Berikut ini adalah jadwal kuliah yang ada di Program Studi S-1 Ilmu psikologi psi, Universitas Sumatera Utara :
					</p>
					<!-- <div class="container mt-5">
					  <div class="content mb-5">
...
<section id="capaian-pembelajaran" class="vision mt-5" x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
	...
	<p class="container mt-5 h5 text-justify">Mahasiwa program sarjana ilmu psikologi diharapkan mampu memahami, menginternalisasikan dan melaksanakan nilai-nilai agama dan keyakinan, Pancasila, dan tanggung jawab etika profesi psikologi serta integritas di dalam kehidupan bermasyarakat, berbangsa, dan bernegara, menguasai asas, teori, doktrin, dalil-dalil psikologi dan norma psikologi sesuai dengan pengetahuan psikologi nasional dan internasional lalu memanfaatkan IPTEK guna melakukan penelitian di bidang psikologi untuk merancang dokumen psikologi dengan menjunjung tinggi etika profesi psikologi, serta menerapkan ilmu psikologi yang berkeadilan melalui kajian dan analisis terhadap masalah psikologi yang terjadi dan berkembang dalam kehidupan masyarakat dalam lingkup nasional dan global, secara berkualitas dan bertanggung jawab, berpikir logis, kritis, sistematis, dan inovatif dan mampu mengambil keputusan secara tepat dalam penyelesaian masalah di bidang psikologi berdasarkan hasil analisis informasi dan data</p>
	<div class="daftar">
		<div class="daftar-konten">
			<div class="nomor">1</div>
			<p>
      Mampu menganalisis kasus/ perkara
      </p>
      </div>
			<div class="daftar-konten">
				<div class="nomor">2</div>
				<p>
				Mampu membuat surat dakwaan (mengajukan penuntutan)
      </p>
				</div>
				<div class="daftar-konten">
					<div class="nomor">3</div>
					<p>
					Mampu menguasai proses persidangan
        </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">4</div>
					<p>
					Mampu menguasai organisasi dalam proses persidangan
        </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">5</div>
					<p>
					Mampu membuat vonis atau putusan dalam suatu perkara
        </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">6</div>
					<p>
					Mampu melakukan interpretasi psikologi
        </p>
					</div>
          <div class="daftar-konten">
          ...
          <div class="daftar-konten">
					...
					<p>
					Mampu menjalankan proses persidangan
        </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">9</div>
					<p>
					Mampu memberikan pandangan atau pendapat psikologi
        </p>
					</div>
				</div>
	</div>
	...
	<h2 class="lined-title">
	  ...
	  <div class="biaya-studi">
              ...
              <div class="judul-studi1"> Program Sarjana<br> <p class="sub-judul-studi">Jalur SNMPTN & SBMTPN</p></div>
              <div class="kotak-deskripsi-biaya-list">
              <div class="nominal-biaya-list">
                <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok I</p><p class ="nominal-ukt">Rp. 500.000</p>
              </div>
              <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok II</p><p class ="nominal-ukt">Rp. 1.000.000</p>
              </div>
              <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok III</p><p class ="nominal-ukt">Rp. 2.000.000</p>
              </div>
              <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok IV</p><p class ="nominal-ukt">Rp. 2.500.000</p>
              </div>
              <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok V</p><p class ="nominal-ukt">Rp. 3.000.000</p>
              </div>
              <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok VI</p><p class ="nominal-ukt">Rp. 3.500.000</p>
              </div>
              <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok VII</p><p class ="nominal-ukt">Rp. 4.500.000</p>
              </div>
              <div class ="flex-nominal-ukt">
               <p class="ukt-kelompok">UKT Kelompok VIII</p><p class ="nominal-ukt">Rp. 5.500.000</p>
              </div>
              </div>
						  <p class="keterangan-per-semester-right-align">per mahasiswa/1 semester</p>
            </div>
						 </div>
             <div class ="biaya-studi-grid-kanan">
              <div class ="biaya-studi-top">
              <div>
              <div class="judul-studi2"> Program Sarjana <p class="sub-judul-studi">Jalur Mandiri </p></div>
              <div class="kotak-deskripsi-biaya">
              <p class="nominal-biaya">Rp. 8.500.000,-</p>
              <p class="keterangan-per-semester">per mahasiswa/1 semester</p>
							</div>
						</div>
          </div>
		  <div class ="biaya-studi-bottom">
               <div class="judul-studi3">Sumbangan Pengembangan Institusi<p class="sub-judul-studi">Jalur Mandiri</p></div>
               <div class="kotak-deskripsi-biaya">
