...
Master's Program in Psychology Studies
</div>
</div>
...
<div class ="grid">
  ...
  <nav class='my-sticky'>
	  ...
	  <a href="#sambutan-kaprodi"  class="section-anchor" :class="{'usu-bg-tertiary text-white': activeSection === $el.hash}">Head of Stud Program's Welcome Speech</a>
...
<section id="sejarah-prodi" class="timeline">
      ...
      <ul>
        <li>
        <div>
                <time>1987</time>The Psychology Study Program was first opened on August 13, 1987 in the form of UGM-USU S2 KPK with only one concentration of science, namely Civil Psychology.
            </div>
        </li>
        <li>
        <div>
                <time>1992</time>The study program was managed independently by USU on November 17, 1992 based on the Decree of the Directorate General of Higher Education Number: 509/DIKTI/KEP/1992. In line with economic developments in the era of globalization and the demands of society, the Master of Psychology Studies Program developed itself by opening concentrations in Criminal Psychology, Constitutional Psychology, Islamic Psychology and Specialty Classes in Economic Psychology.
            </div>
        </li>
	    </ul>
</section>
<section id="visi-misi" class="vision mt-5"  x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
    ...
    Becoming a Learning Center for Legal Sciences at the Masters Level, a Leading Center for Legal Studies and Information Nationally with graduates who are qualified, moral, professional, and have a competitive advantage both at the national and international levels.
    </p>
	<div class="missions">
    <div class="container">
		...
		<div class="d-block d-sm-flex justify-content-center flex-wrap p-2">
			...
			<img src="https://api.iconify.design/fluent:building-bank-20-regular.svg?color=white&width=60px"/>
			  ...
			  <h2 style="text-align:center">Legal Science Learning Center</h2>
    ...
    <div class="container">
		<div class="akreditasi-list">
			<div class="kontenakreditasi">
			  <h2>Master's Program in Psychology Studies</h2>
		...
		<div class="popup-container">
				...
				<p>
					<a class="popup-close" href="#closed">X</a>
						...
						<h3>
						Accreditation of USU Master of Psychology Studies Program
						</h3>
					</div>
...
<div class ="grid">
  ...
  <nav class='my-sticky'>
				  ...
				  <a href="#biaya-studi" class="section-anchor"  :class="{'usu-bg-tertiary text-white': activeSection === $el.hash}">Study Fees</a>
</nav>
</div>
<div class ="grid-right">
<section id = "jadwal-kuliah" class="vision mt-5" x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
          ...
          The following is the schedule of classes in the Master of Psychology Studies Program, Universitas Sumatera Utara :
					</p>
					<!-- <div class="container mt-5">
					  <div class="content mb-5">
...
<section id="peminatan" class="vision mt-5" x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
    ...
    <div class="item-kelompok-keilmuan item-keilmuan-active" data-toggle="modal" data-target="#ShowModal4">
		...
		<div class="item-kelompok-keilmuan item-keilmuan-active" data-toggle="modal" data-target="#ShowModal6">
          ...
          <p>Economic Psychology Specialized Class</p>
        </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="ShowModal3" tabindex="-1" aria-labelledby="ShowModalLabel" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered"><div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="ShowModalLabel">Corporate Psychology</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">X</span>
        </button></div><div class="modal-body modal-body-bidang-keilmuan">
          <img src="https://konten.usu.ac.id/storage/satker/15/statis/psikologi-bisnis.jpg" alt="">
          <p>
          Corporate Psychology is the body of Psychology governing the rights, relations, and conduct of persons, companies, organizations and businesses. The term refers to the legal practice of Psychology relating to corporations, or to the theory of corporations
          </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
	...
	<div class="modal fade" id="ShowModal5" tabindex="-1" aria-labelledby="ShowModalLabel" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered"><div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="ShowModalLabel">Islamic Psychology (Sharia)</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">X</span>
        </button></div><div class="modal-body modal-body-bidang-keilmuan">
          <img src="https://konten.usu.ac.id/storage/satker/15/statis/psikologi-islam.jpg" alt="">
          <p>
          Islamic Psychology or Sharia is a body of religious Psychology that forms a part of the Islamic tradition. It is derived from the religious precepts of Islam and is based on the sacred scriptures of Islam, particularly the Quran and the Hadith
          </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="ShowModal6" tabindex="-1" aria-labelledby="ShowModalLabel" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered"><div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="ShowModalLabel">Economic Psychology Specialized Class</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">X</span>
        </button></div><div class="modal-body modal-body-bidang-keilmuan">
          <img src="https://konten.usu.ac.id/storage/satker/15/statis/psikologi-ekonomi.jpg" alt="">
...
<section id="capaian-pembelajaran" class="vision mt-5" x-intersect.margin.-225px.0px.-70%.0px="activeSection = '#' + $el.id">
	...
	<p class="container mt-5 h5 text-justify">Students are expected to acquire logical, analytical, systematic, and creative cognitive abilities and be able to analyze legal phenomena, legal indicators, and legal events that occur in society through the application of legal principles. With the learning attainment targets, it is anticipated that students would be able to communicate legal theories and legal doctrines in general or in line with the field of Psychology to the academic community and the broader community through the media.</p>
	<div class="daftar">
		<div class="daftar-konten">
			<div class="nomor">1</div>
			<p>
      Mastering and applying legal principles, legal theory, and legal doctrines to the drafting of legal arguments
      </p>
      </div>
			<div class="daftar-konten">
				<div class="nomor">2</div>
				<p>
        Able to conduct academic validation or study in the area of Psychology in which the student has competence in solving problems in relevant society or industry through the development of knowledge and expertise in the field of Psychology in general and in the area of Psychology in which he specializes.
        </p>
				</div>
				<div class="daftar-konten">
					<div class="nomor">3</div>
					<p>
          Capable of developing logical, critical, systematic, and innovative thought through scientific research in the field of Psychology, compiling scientific conceptions and results of studies based on scientific principles, procedures, and ethics in the form of theses, and uploading them to college websites, as well as papers published in scientific journals accredited or accepted by international journals.
          </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">4</div>
					<p>
          Capable of compiling ideas, thoughts, and legal reasoning responsibly and in accordance with academic ethics and communicating them through the media to the academic community and the larger community.
          </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">5</div>
					<p>
          Capable of doing legal research by utilizing normative juridical, empirical juridical, and functional approaches to the science of Psychology
          </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">6</div>
					<p>
          Mastering positive Psychology in general and in one's area of specialization (expertise concentration)
          </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">7</div>
					<p>
          Mastering legal theories at the levels of grand theory, middle theory, and applied theory, as well as legal doctrines pertinent to the area of concentration or specialization (civil Psychology, criminal Psychology, state administration Psychology, state constitutional Psychology, business Psychology and economic Psychology)
          </p>
					</div>
          <div class="daftar-konten">
					<div class="nomor">8</div>
					<p>
          Mastering legal theories both at the level of grand theory, middle theory and applied theory and doctrines of Psychology in accordance with the field of concentration or expertise (civil Psychology, criminal Psychology, state administrative Psychology, constitutional Psychology, business Psychology and economic Psychology).
          </p>
					</div>
				</div>
	</div>
	  ...
	  Based on the Decree of the USU Chancellor Number 1610/UN.1.R/SK/KEU/2022 concerning tuition fees for study programs for professional, specialist and postgraduate (master and doctoral) education levels at the University of North Sumatra for the 2022/2023 academic year, the following is the amount of tuition fees for each learner entry point:
	    ...
	    <div class="biaya-studi">
              ...
              <p class="keterangan-per-semester">per student/1 semester</p>
							...
							<div class="judul-studi4 mt-3"> Re-registration</div>
              <div class="kotak-deskripsi-biaya">
